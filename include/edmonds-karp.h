...
/*   Updated: 2020/07/16 02:11:58 by unite            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
** @var s_edkarp::graph
** @brief The graph on which the algorithm is running
** @var s_edkarp::source
** @brief The source vertex
** @var s_edkarp::sink
** @brief The sink vertex
** @var s_edkarp::marked
** @brief A boolean array denoting which vertices are on previously found
...
/*
** @brief Initializes a run of the Edkmonds-Karp algorithm
...
** Computes the next augmenting (shortest) path from source to sink,
** given the current state of the Edmonds-Karp algorithm
